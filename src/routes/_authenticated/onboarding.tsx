      ...
      <div className="mx-auto w-full max-w-lg">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mt-1 font-display text-[22px] font-bold tracking-tight">
            {step === 1 ? "Set up your workspace" : step === 2 ? "Add your first property" : "You're ready"}
          </h1>
          ...
          {step === 1 ? (
            <form onSubmit={submitWorkspace} className="space-y-3">
              ...
              <FormGrid>
                <Field label="Workspace name" htmlFor="name" hint="Shown to your tenants.">
                  <TextInput id="name" name="name" required placeholder="Whitfield Property Group" />
                </Field>
                <Field label="Legal entity" htmlFor="legalEntityName" hint="Optional.">
                  <TextInput id="legalEntityName" name="legalEntityName" placeholder="Whitfield Holdings LLC" />
                </Field>
              </FormGrid>
              <Field label="Phone" htmlFor="phone" hint="Optional — used for maintenance escalation.">
            ...
            <form onSubmit={submitProperty} className="space-y-3">
              ...
              <Field label="Street address" htmlFor="streetAddress">
                <TextInput id="streetAddress" name="streetAddress" required placeholder="1420 Maple Court" />
              </Field>
            ...
            <div className="space-y-3">
              ...
              <Button className="w-full" onClick={() => void navigate({ to: "/dashboard", replace: true })}>
                Go to dashboard
              </Button>
              <DemoNotice>
                Everything you create now lives in this preview only. When the backend reconnects the same flows write
